    ...
    , setupRow: function(inSender, inEvent) {
        ...
        inEvent.template={components: [
          ...
          , { kind: "FittableColumns", components: [
            ...
            , {kind: "onyx.Button", content: "Archive", ontap: 'archiveMessage', showing:!(inEvent.context.archiveFlag), id: 'archiveMessage_'+inEvent.context._id, owner: this, classes:'list-item-margin'}
